...
import { AddStudent, updateStudent } from "../../Services/Action/StudentAction/StudentAction";
...
const Edit = () => {
  ...
  const [value, setValue] = useState(useSelector( (state) => state.StudentReducer.students  ).find((val) => val.id === id  ));
